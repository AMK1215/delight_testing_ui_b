    ...
    return <div className='text-sm'>
        ...
        <div className="border-l-2 pl-2 border-zinc-500">
            {['CQ9', 'PGSoft', 'JILI', 'JILI'].map((item, index) => {
                return <div className="cursor-pointer transition-all ease-in-out duration-200 text-sm mb-1 text-zinc-500 hover:text-active font-medium flex items-center gap-1">
                    <LinkIcon size={15} />
                    {item}
                </div>
            })}
